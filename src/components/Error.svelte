<section class="flex items-center h-full sm:p-16">
	...
	>
		...
		<p class="text-3xl text-white">Looks like our services are currently offline</p>
		<a rel="noopener noreferrer" href="/" class="px-8 py-3 font-semibold rounded text-white"
			>Back to homepage</a
		>
	</div>
</section>
